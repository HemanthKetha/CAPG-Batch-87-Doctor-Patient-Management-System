 ...
 * 		     doctor_file_maintenance	    - managing doctor details
		     doctor_license_query	    - viewing the appointments of a particular doctor  
 *
 *
 * ********************************************************************************************************/
...
/**********************************************************************************************************
 * *FILENAME        :patient_file_maintenance
 *
...
/**********************************************************************************************************
 * *FILENAME        :doctor_file_maintenance
 *
 * *DESCRIPTION     :This function is used to manage patient details by taking choice option from the admin.
 *
...
/**********************************************************************************************************
 * *FILENAME        :doctor_login
 *
 * *DESCRIPTION     :This function will allow the doctor to login with the help of login id and password and can choose different choice options according to his/her preference
 *
...
int doctor_login()
{
	...
	while(1)
	{
		...
		if(!ptr)
		{
			printf("\n Invalid MCI no or  password, please try again\n");
			continue;
		}
		if(ptr)
		{
...
int patient_corner()
{
	...
	{
		printf("\n......enter patient data......\n");
		printf("1.patient registration\n2.existing patient to book appointment\n3.Exit");
		printf("\nEnter choice-");
		scanf("%d",&ch);
		switch(ch)
		{
