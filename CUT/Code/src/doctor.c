 ...
 * *FILENAME	      : doctor.c
 *
 * *DESCRITION        : This file defines the functions that are used by doctor to register ,to view appointment details,to record patient history,to view patient history and to edit the basic information of the doctor 
 *
 *
 * Revision History   :	       
 *
 ...
 *
 * *DESCRITION                : This function is used by the new doctor for registration.
 *
**************************************************************************************/
 ...
 *
 * *DESCRITION                : This function is used by the doctor to view the bookings.
 *
**************************************************************************************/
...
int view_bookings()
{
	...
	while(1)
	{
		printf("\nenter mci no\n");
		scanf("%d",&mc);
		for(ptr2=start2;(ptr2) && ptr2->license_no!=mc;ptr2=ptr2->next);
			...
			{
				printf("\nno bookings are present for this %d MCI number\n",mc);
			}
...
/*************************************************************************************
 * *FUNCTION NAME	      : record_patient_history
 *
 * *DESCRITION                : This function is used by the doctor to record the patient history.
 *
**************************************************************************************/
 ...
 *
 * *DESCRITION                : This function is used by the doctor to view the patient history.
 *
**************************************************************************************/
...
int view_patient_history()
{
	...
	/*	if(pt)
		...
		printf("NAME     AGE  WEIGHT  DISEASE  TREATMENT  MEDICINE \n");
		printf("\n%s---%d---%d---%s---%s---%s\n",pt->rpt_name,pt->rpt_age,pt->rpt_weight,pt->disease,pt->treatment,pt->medicine);
		break;
	}
	return EXIT_SUCCESS;
 ...
 *
 * *DESCRITION                : This function is used by the doctor and admin to edit the basic information of doctor.
 *
**************************************************************************************/
 ...
 *
 * *DESCRITION                : This function is used by the admin to view the information of doctor.
**************************************************************************************/
...
/*************************************************************************************
 * *FUNCTION NAME	      : delete_doctor_info
 *
 * *DESCRITION                : This function is used by the admin to delete the information of doctor.
**************************************************************************************/
 ...
 *
 * *DESCRITION                : This function is used by the admin to view the appointments of the particular doctor.
 *
**************************************************************************************/
...
// This function is to store doctor data from file to list
...
// This function is to store doctor data from list to file
...
//This function to record patient history from file to list
...
//This function to record patient history from list to file
